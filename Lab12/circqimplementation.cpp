...
void CircularQ::enqueue(QueElement item){
...
CircularQ::CircularQ(const CircularQ &origQ){ // Copy constructor
...
CircularQ &CircularQ::operator=(const CircularQ &rhs){
